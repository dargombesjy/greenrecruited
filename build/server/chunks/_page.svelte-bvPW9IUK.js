import { l as setContext, c as attr, j as stringify, d as escape_html, k as ensure_array_like } from './index2-CzbQFEwn.js';
import { P as PUBLIC_STRAPI_URL } from './public-CGSgOEA6.js';
import './root-BsQ74_k9.js';
import './state.svelte-BnJgE87I.js';
import { B as BlocksRenderer } from './BlocksRenderer-Ba5IuMog.js';

function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data } = $$props;
    setContext("parent_node", () => data.data[0].parent);
...
//# sourceMappingURL=_page.svelte-bvPW9IUK.js.map
