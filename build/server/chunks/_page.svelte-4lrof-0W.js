import { c as attr, j as stringify, d as escape_html, k as ensure_array_like, l as derived } from './index2-CFsRFmOn.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <div class="mt-8 mb-4 text-center text-2xl">${escape_html(data.data[0].long_title)}</div> <div class="my-4 self-center text-xl">`);
    ...
    if (nextpar()) {
      $$renderer2.push("<!--[1-->");
      $$renderer2.push(`<button class="mt-4 w-48 cursor-pointer self-center rounded-[20px] bg-primary-50 py-4 text-center text-white">Simulasi Berikutnya</button>`);
    } else {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<button class="mt-4 w-48 cursor-pointer self-center rounded-[20px] bg-primary-50 py-4 text-center text-white">Reset</button>`);
    }
    $$renderer2.push(`<!--]--></div>`);
  });
}
...
//# sourceMappingURL=_page.svelte-4lrof-0W.js.map
